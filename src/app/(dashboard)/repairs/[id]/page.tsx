...
export default async function RepairDetailsPage({
    ...
    Technician: {ticket.assignedTechnician?.fullName ?? "Unassigned"}
      ...
      <div className="bg-white border border-orange-200 rounded-lg p-4">
        <div className="flex items-center justify-between mb-3">
          <h2 className="font-semibold text-orange-500 text-xs uppercase tracking-wide">
        ...
        <form action={uploadMediaAction}>
          ...
          <button type="submit" className="ml-2 rounded-md bg-orange-600 text-white px-3 py-1.5 text-sm">
            Upload
          </button>
        </form>
      </div>
  ...
  <form action={addPartToRepairAction} className="flex items-end gap-3">
    <input type="hidden" name="repairId" value={ticket.id} />
    ...
    <button type="submit" className="rounded-md bg-orange-600 text-white px-4 py-2 text-sm font-medium hover:bg-orange-700">
      ...
      <div className="bg-white border border-orange-200 rounded-lg p-4">
        ...
        <form action={updateStatusAction} className="border-t border-slate-100 pt-4 flex items-end gap-3">
          <input type="hidden" name="repairId" value={ticket.id} />
          <div className="flex-1">
  ...
  <form action={addPaymentAction} className="flex items-end gap-3">
    <input type="hidden" name="repairId" value={ticket.id} />
    <div>
      <label className="block text-xs font-medium mb-1">Type</label>
      <select name="paymentType" required className="rounded-md border border-orange-300 px-3 py-2 text-sm">
    ...
    <div>
      ...
      <select name="paymentMethod" required className="rounded-md border border-orange-300 px-3 py-2 text-sm">
